...
| 008 | Search | planned | [008-search.md](008-search.md) | General-purpose query command with filename, date, EXIF, size, and visual similarity search. Human-readable and porcelain output modes. |
